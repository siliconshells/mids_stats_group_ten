...
Sodium_intake_impute_model <- lm(Sodium_intake ~ Systolic_BP + Diastolic_BP, data = data_for_model)
...
# Build the linear model
Systolic_BP_impute_model <- lm(Systolic_BP ~ Sodium_intake + Alcohol_consumption, data = data_for_model)
...
# Build the linear model
Diastolic_BP_impute_model <- lm(Diastolic_BP ~ Sodium_intake + Alcohol_consumption, data = data_for_model)
...
# Build the linear model
Alcohol_consumption_impute_model <- lm(Alcohol_consumption ~ Systolic_BP + Diastolic_BP, data = data_for_model)
