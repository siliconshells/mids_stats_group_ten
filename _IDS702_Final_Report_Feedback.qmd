...
kable(summary_table, caption = "Model Coefficients", longtable = TRUE) %>%
...
kable(p_values_table, caption = "P-Values for Model Coefficients", longtable = TRUE) %>%
  kable_styling(full_width = FALSE, position = "center", latex_options = "scale_down", font_size = 7, bootstrap_options = c("striped", "hover"))
