...
data_for_model <- data_q1_3_measures %>%
  filter(!is.na(DR1TSODI), !is.na(BPXOSY1), !is.na(BPXOSY2), !is.na(BPXOSY3),
         !is.na(BPXODI1), !is.na(BPXODI2), !is.na(BPXODI3))

# Build the linear model
DR1TSODI_impute_model <- lm(DR1TSODI ~ BPXOSY1 + BPXOSY2 + BPXOSY3 +
                            BPXODI1 + BPXODI2 + BPXODI3, data = data_for_model)

# Identify rows where DR1TSODI is missing
missing_DR1TSODI <- is.na(data_q1_3_measures$DR1TSODI)

# Filter rows with missing DR1TSODI but no missing predictors for prediction
rows_for_prediction <- data_q1_3_measures[missing_DR1TSODI, ] %>%
  filter(!is.na(BPXOSY1), !is.na(BPXOSY2), !is.na(BPXOSY3),
         !is.na(BPXODI1), !is.na(BPXODI2), !is.na(BPXODI3),)

# Predict DR1TSODI for the rows where it can be predicted
predicted_DR1TSODI <- predict(DR1TSODI_impute_model, newdata = rows_for_prediction)

# Impute the predicted values back into the dataset
data_q1_3_measures$DR1TSODI[missing_DR1TSODI] <- predicted_DR1TSODI
...
# data_for_model <- data_q1_3_measures %>%
#   filter(!is.na(DR1TSODI), !is.na(BPXOSY1), !is.na(BPXOSY2), !is.na(BPXOSY3),
#          !is.na(DR1TALCO), !is.na(BPXODI2), !is.na(BPXODI3))
# 
# # Build the linear model
# BPXOSY1_impute_model <- lm(BPXOSY1 ~ DR1TSODI + BPXOSY2 + BPXOSY3 +
#                             DR1TALCO + BPXODI2 + BPXODI3, data = data_for_model)
# 
# # Identify rows where BPXOSY1 is missing
# missing_BPXOSY1 <- is.na(data_q1_3_measures$BPXOSY1)
# 
# # Filter rows with missing BPXOSY1 but no missing predictors for prediction
# rows_for_prediction <- data_q1_3_measures[missing_BPXOSY1, ] %>%
#   filter(!is.na(DR1TSODI), !is.na(BPXOSY2), !is.na(BPXOSY3),
#          !is.na(DR1TALCO), !is.na(BPXODI2), !is.na(BPXODI3),)
# 
# # Predict BPXOSY1 for the rows where it can be predicted
# predicted_BPXOSY1 <- predict(BPXOSY1_impute_model, newdata = rows_for_prediction)
# 
# # Impute the predicted values back into the dataset
# data_q1_3_measures$BPXOSY1[missing_BPXOSY1] <- predicted_BPXOSY1
# 


# # 2. Impute BPXOSY1 ()
# BPXOSY1_impute_model <- lm(BPXOSY1 ~ DR1TSODI + BPXOSY2 + BPXOSY3 + BPXODI1 + BPXODI2 + BPXODI3 + DR1TALCO,
#                          data = subset(data_q1_3_measures, !is.na(BPXOSY1)))
# 
# missing_BPXOSY1 <- is.na(data_q1_3_measures$BPXOSY1)
# predicted_BPXOSY1 <- predict(BPXOSY1_impute_model, newdata = data_q1_3_measures[missing_BPXOSY1,])
# 
# BPXOSY1_noise <- rnorm(n = length(predicted_BPXOSY1),
#                       mean = 0,
#                       sd = summary(BPXOSY1_impute_model)$sigma)
# 
# data_q1_3_measures$BPXOSY1[missing_BPXOSY1] <- predicted_BPXOSY1 + BPXOSY1_noise
#
...
#                          data = subset(data_q1_3_measures, !is.na(BPXOSY2)))
# 
# missing_BPXOSY2 <- is.na(data_q1_3_measures$BPXOSY2)
# predicted_BPXOSY2 <- predict(BPXOSY2_impute_model, newdata = data_q1_3_measures[missing_BPXOSY2,])
# 
# BPXOSY2_noise <- rnorm(n = length(predicted_BPXOSY2),
#                       mean = 0,
#                       sd = summary(BPXOSY2_impute_model)$sigma)
# 
# data_q1_3_measures$BPXOSY2[missing_BPXOSY2] <- predicted_BPXOSY2 + BPXOSY2_noise
# 
# # 4. Impute BPXOSY3 ()
# BPXOSY3_impute_model <- lm(BPXOSY3 ~ DR1TSODI + BPXOSY1 + BPXOSY2 + BPXODI1 + BPXODI2 + BPXODI3 + DR1TALCO,
#                          data = subset(data_q1_3_measures, !is.na(BPXOSY3)))
# 
# missing_BPXOSY3 <- is.na(data_q1_3_measures$BPXOSY3)
# predicted_BPXOSY3 <- predict(BPXOSY3_impute_model, newdata = data_q1_3_measures[missing_BPXOSY3,])
# 
# BPXOSY3_noise <- rnorm(n = length(predicted_BPXOSY3),
#                       mean = 0,
#                       sd = summary(BPXOSY3_impute_model)$sigma)
# 
# data_q1_3_measures$BPXOSY3[missing_BPXOSY3] <- predicted_BPXOSY3 + BPXOSY3_noise
# 
# 
# # 5. Impute BPXODI1 ()
# BPXODI1_impute_model <- lm(BPXODI1 ~ DR1TSODI + BPXOSY1 + BPXOSY2 + BPXOSY3 + BPXODI2 + BPXODI3 + DR1TALCO,
#                          data = subset(data_q1_3_measures, !is.na(BPXODI1)))
# 
# missing_BPXODI1 <- is.na(data_q1_3_measures$BPXODI1)
# predicted_BPXODI1 <- predict(BPXODI1_impute_model, newdata = data_q1_3_measures[missing_BPXODI1,])
# 
# BPXODI1_noise <- rnorm(n = length(predicted_BPXODI1),
#                       mean = 0,
#                       sd = summary(BPXODI1_impute_model)$sigma)
# 
# data_q1_3_measures$BPXODI1[missing_BPXODI1] <- predicted_BPXODI1 + BPXODI1_noise
# 
# # 6. Impute BPXODI2 ()
# BPXODI2_impute_model <- lm(BPXODI2 ~ DR1TSODI + BPXOSY1 + BPXOSY2 + BPXOSY3 + BPXODI1 + BPXODI3 + DR1TALCO,
#                          data = subset(data_q1_3_measures, !is.na(BPXODI2)))
# 
# missing_BPXODI2 <- is.na(data_q1_3_measures$BPXODI2)
# predicted_BPXODI2 <- predict(BPXODI2_impute_model, newdata = data_q1_3_measures[missing_BPXODI2,])
# 
# BPXODI2_noise <- rnorm(n = length(predicted_BPXODI2),
#                       mean = 0,
#                       sd = summary(BPXODI2_impute_model)$sigma)
# 
# data_q1_3_measures$BPXODI2[missing_BPXODI2] <- predicted_BPXODI2 + BPXODI2_noise
# 
# 
# # 7. Impute BPXODI3 ()
# BPXODI3_impute_model <- lm(BPXODI3 ~ DR1TSODI + BPXOSY1 + BPXOSY2 + BPXOSY3 + BPXODI1 + BPXODI2 + DR1TALCO,
#                          data = subset(data_q1_3_measures, !is.na(BPXODI3)))
# 
# missing_BPXODI3 <- is.na(data_q1_3_measures$BPXODI3)
# predicted_BPXODI3 <- predict(BPXODI3_impute_model, newdata = data_q1_3_measures[missing_BPXODI3,])
# 
# BPXODI3_noise <- rnorm(n = length(predicted_BPXODI3),
#                       mean = 0,
#                       sd = summary(BPXODI3_impute_model)$sigma)
# 
# data_q1_3_measures$BPXODI3[missing_BPXODI3] <- predicted_BPXODI3 + BPXODI3_noise
# 
# 
# # 8. Impute DR1TALCO ()
# DR1TALCO_impute_model <- lm(DR1TALCO ~ DR1TSODI + BPXOSY1 + BPXOSY2 + BPXOSY3 + BPXODI1 + BPXODI2 + BPXODI3,
#                          data = subset(data_q1_3_measures, !is.na(DR1TALCO)))
# 
# missing_DR1TALCO <- is.na(data_q1_3_measures$DR1TALCO)
# predicted_DR1TALCO <- predict(DR1TALCO_impute_model, newdata = data_q1_3_measures[missing_DR1TALCO,])
# 
# DR1TALCO_noise <- rnorm(n = length(predicted_DR1TALCO),
#                       mean = 0,
#                       sd = summary(DR1TALCO_impute_model)$sigma)
# 
# data_q1_3_measures$DR1TALCO[missing_DR1TALCO] <- predicted_DR1TALCO + DR1TALCO_noise



# Verify no missing values remain
colSums(is.na(data_q1_3_measures))
```

```{r, results='hide'}
# take the mean of the three blood pressure measurements (both systolic and diastolic)
# Clone data_q1_3_measures
data_q1 <- data.frame(data_q1_3_measures)

data_q1$BPXOSY <- rowMeans(data_q1[, c("BPXOSY1", "BPXOSY2", "BPXOSY3")], na.rm = TRUE)
data_q1$BPXODI <- rowMeans(data_q1[, c("BPXODI1", "BPXODI2", "BPXODI3")], na.rm = TRUE)
...
# Renaming columns
colnames(data_q1) <- c("Sequence_no", "Gender", "Age", "Race", "Sodium_intake", "Systolic_BP", "Diastolic_BP", "Alcohol_consumption")
glimpse(data_q1)
```
...
Finally, we explored the relationship between sodium intake and blood pressure categories using Spearman’s rank correlation coefficient. Initially, the correlation calculation returned an NA value, likely due to the presence of missing or non-numeric values in the data. After addressing these issues by ensuring all relevant values were complete and properly formatted, the Spearman correlation was computed. The resulting coefficient was , indicating a weak positive association". [to be computed]
...
data_q1$BP_category_num <- as.numeric(data_q1$BP_category)

# Calculate Spearman correlation (appropriate for ordinal variables)
correlation <- cor(data_q1$Sodium_intake, data_q1$BP_category_num, method = "spearman")
...
ggplot(data_q1, aes(x = BP_category, y = Sodium_intake)) +
