...
To assess multicollinearity, Variance Inflation Factors (VIFs) were calculated for each predictor. All VIF values were below the threshold of 5, indicating that multicollinearity is not a major issue in the model. **RaceNon-Hispanic White** had the highest VIF (3.46), suggesting a moderate level of correlation with other predictors, but it does not indicate a severe problem. The rest of the predictors, including **Sodium_intake**, **Age**, **Gender**, and **Alcohol_consumption**, had low VIFs, indicating minimal collinearity.
